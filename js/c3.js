    ...
    c3.generate = function (config) {
        ...
        var __tooltip_show = getConfig(['tooltip', 'show'], true),
            ...
            for (i = 0; i < d.length; i++) {
                ...
                // CUSTOM CODE: don't show GT or FNY in tooltip for week of hack overlap
                /*if(typeof(source_exists[title]) == "undefined") {
                    source_exists[title] = {};
                } else {
                    source_exists[title][d[i].id] = 1;
                }
                if(typeof(source_exists[title]['FNY']) != "undefined" && d[i].id == "FNY-Forecast") {
                    continue;
                }
                if(typeof(source_exists[title]['GT']) != "undefined" && d[i].id == "GT-Forecast") {
                    continue;
                }*/
                text += "<tr class='" + CLASS.tooltipName + "-" + d[i].id + "'>";
                //text += "<td class='name'><span style='background-color:" + bgcolor + "'></span>" + name + "</td>";
                text += "<td class='value'>" + value + " cases</td>";
                text += "</tr>";
            }
            return text + "</table>";
        }),
